...
local key_maps = {
  ...
  { mode = 'i', key = '<c-k>', func = vim.lsp.signature_help, desc = 'signaturehelp' },
  ...
  { key = '<S-k>', func = vim.lsp.buf.hover, desc = 'hover' },
  {
    key = '<Leader>ca',
    mode = 'n',
  ...
  { key = '<Leader>cD', func = require('navigator.diagnostics').show_diagnostics, desc = 'show all diagnostic' },
  {
    key = '<Leader>cd',
  ...
  { key = '<Leader>ck', func = require('navigator.dochighlight').hi_symbol, desc = 'highlight symbols' },
  -- {
  --   key = "<Space>wa",
  ...
  { key = '<Leader>cf', func = vim.lsp.buf.range_formatting, mode = 'v', desc = 'range format' },
  -- {
  --   key = "<Space>gm",
